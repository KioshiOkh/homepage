  ...
  return (
    <>
        <div className='flex justify-center flex-col w-[40vw] h-[28vh] mt-28'>
            <h2 className='text-white -mt-20 mb-8 font-bold'>
            ...
            <div className=' shadow-md rounded-xl w-[42vw] lg:w-[20vw] xl:w-[10vw] h-[60vh] flex justify-center items-center flex-col gray-radient'>
              <label className='text-white underline underline-offset-4'>
                    Startdatum{": "}
                    <input className="bg-transparent rounded-lg" type='date' value={startDate} onChange={(e) => setStartDate(e.target.value)}/>
                  </label>
                  <br />
                  <button 
                  ...
                  {nights !== null && (
                    <div className='text-white leading-10'>
                      <h2>Du hast <span className='text-blue-700 font-bold'>{nights} </span>Nächte geschlafen!</h2>
                    </div>
                    )}
            </div>
        </div>
